...
-- Example: :DB mysql://user:pass@mysql.local:3306 SHOW DATABASES;

https://github.com/kristijanhusak/vim-dadbod-ui
To add a new dtabase, toggle DBUI, then hit capital `A` to add a new connection
-- mysql://user:pass@mysql.local:3306
-- mysql://user:pass@mariadb.local:3306/
-- postgres://postgres:pass@postgres.local:5432/
...
return {
  ...
  -- DB connection strings (includes passwords in plaintext, so do not track
  -- this file. Default location is `~/.local/share/db_ui`)
  -- On Linux, use a neutral path by default:
