...
return {
  ...
  opts = function(_, opts)
    ...
    -- NOTE: Removed YouTube/linkarzu-specific snippet loading
    -- Custom snippets
    ...
    -- Keep generic pagebreak helpers
    table.insert(
      snippets,
      s({ trig = "newline", name = "Insert HTML pagebreak", desc = "Insert HTML pagebreak" }, {
        t('<div style="page-break-after: always; visibility: hidden"> pagebreak </div>'),
      })
    )
    table.insert(
      snippets,
      s({ trig = "pagebreak", name = "Insert HTML pagebreak", desc = "Insert HTML pagebreak" }, {
        t('<div style="page-break-after: always; visibility: hidden"> pagebreak </div>'),
      })
    )

    -- Removed linkarzu/YouTube/social-specific blocks
    ...
    --                         all the filetypes
    -- #####################################################################
    -- Remove personal filler snippets; keep "all" clean
    ls.add_snippets("all", {})
