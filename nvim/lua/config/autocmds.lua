...
-- C/C++ specific settings for better parsing and folding
vim.api.nvim_create_autocmd("FileType", {
...
-- options.lua file
--
-- DISABLED: Diagnostic popups are annoying when using Trouble plugin
-- vim.api.nvim_create_autocmd({ "CursorHold", "CursorHoldI" }, {
--   group = vim.api.nvim_create_augroup("float_diagnostic", { clear = true }),
--   callback = function()
--     -- Only show diagnostics if there are LSP clients attached to the current buffer
