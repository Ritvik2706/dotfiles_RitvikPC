...
# Basic color setup for tmux catppuccin theme

# Default color scheme (you can customize these)
linkarzu_color02="#f38ba8"  # Red/Pink
linkarzu_color03="#89b4fa"  # Blue  
linkarzu_color04="#f9e2af"  # Yellow
linkarzu_color07="#45475a"  # Surface0
linkarzu_color08="#fab387"  # Peach
linkarzu_color09="#6c7086"  # Overlay0
linkarzu_color10="#313244"  # Surface0
linkarzu_color13="#cdd6f4"  # Text
linkarzu_color14="#a6e3a1"  # Green
linkarzu_color23="#585b70"  # Surface2

# Optional: Source colorscheme file if it exists
